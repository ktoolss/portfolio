...
$(document).ready(function(){
    ...
    .then(function(successArray){
        ...
        successArray.forEach(function(success){
            // set the js var to completed using a string and change the css class by inserting in html
            $("ul").append(
                `<li data-id =${success._id} class="">${success}<span><i class='far fa-trash-alt'></i></span></li>`
                );
        })
    })
...
$("input").keypress(function (event) {
    ...
    .then(function(newPerson){
        ...
        $("ul").append(
            `<li data-id=${newPerson._id}>${newPerson}<span><i class='far fa-trash-alt'></i></span></li>`
            );
